...
return [
    ...
    */
    ...
    'custom_cms_name' => env('STATAMIC_CUSTOM_CMS_NAME', 'Floorplate'),

    'custom_logo_url' => env('STATAMIC_CUSTOM_LOGO_URL', [
        'nav' => '/assets/logo-mark-black-sm.svg',
        'outside' => '/assets/logo-mark-black-sm.svg'
    ]),

    'custom_dark_logo_url' => env('STATAMIC_CUSTOM_DARK_LOGO_URL', [
        'nav' => '/assets/logo-mark-white-sm.svg',
        'outside' => '/assets/logo-mark-white-sm.svg'
    ]),

    'custom_logo_text' => env('STATAMIC_CUSTOM_LOGO_TEXT', null),

    'custom_favicon_url' => env('STATAMIC_CUSTOM_FAVICON_URL', '/assets/favicon.svg'),
